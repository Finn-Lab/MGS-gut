...
# initial mapping
bsub -n 8 -q production-rh7 -M 40000 -oo ${outprefix}_${refix}_mapping.log -J bwa_${readname}_${refix} \
"bwa mem -t 8 ${ref} ${reads} ${reads2} | samtools view -@ 7 -uS - -o ${outprefix}_${refix}_unsorted.bam"

# sort bam file
bsub -n 8 -q production-rh7 -M 40000 -o ${outprefix}_${refix}_mapping.log  -J sort_${readname}_${refix} -w "ended(bwa_${readname}_${refix})" \
"samtools sort -@ 7 ${outprefix}_${refix}_unsorted.bam -o ${outprefix}_${refix}_sorted.bam"

# extract unique counts
bsub -n 8 -q production-rh7 -M 5000 -o ${outprefix}_${refix}_mapping.log  -J unique_${readname}_${refix} -w "ended(sort_${readname}_${refix})" \
"samtools view -@ 7 -q 1 -f 2 -u ${outprefix}_${refix}_sorted.bam -o ${outprefix}_${refix}_unique_sorted.bam"
bsub -n 8 -q production-rh7 -o ${outprefix}_${refix}_mapping.log  -J index-unique_${readname}_${refix} -w "ended(unique_${readname}_${refix})" \
"samtools index -@ 7 ${outprefix}_${refix}_unique_sorted.bam"
bsub -q production-rh7 -M 10000 -o ${outprefix}_${refix}_mapping.log  -J depth-unique_${readname}_${refix} -w "ended(index-unique_${readname}_${refix})" \
...
bsub -n 8 -q production-rh7 -o ${outprefix}_${refix}_mapping.log  -J index_${readname}_${refix} -w "ended(sort_${readname}_${refix})" \
"samtools index -@ 7 ${outprefix}_${refix}.bam"
bsub -q production-rh7 -M 10000 -o ${outprefix}_${refix}_mapping.log  -J depth_${readname}_${refix} -w "ended(index_${readname}_${refix})" \
